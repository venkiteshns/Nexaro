...
import { ChevronDown, Search, CheckCircle2, Clock3, ShieldCheck, UserX, ChevronLeft, ChevronRight } from "lucide-react";
import { useAdminGetUsersQuery } from "../../store/services/api";
...
const UserManagement = () => {
  ...
  const { data, isLoading, isError } = useAdminGetUsersQuery({ page: currentPage, limit: 10 });
                  ...
                  <tbody>
                    ...
                    {!isLoading && !isError && users.map((user) => (
                      ...
                      >
                          ...
                          <div className="flex items-center gap-2">
                            {user.isVerified ? (
                              <>
                                ...
                                <span className="font-medium text-sm text-emerald-600">Verified</span>
                              </>
                            ) : (
                              <>
                                <Clock3 size={18} className="text-yellow-500" />
                                <span className="font-medium text-sm text-yellow-600">Pending</span>
                              </>
                            )}
                          </div>
                        </td>
                        ...
                        <td className="px-6 py-6">
                          <span className={`font-medium ${user.isSuspended ? "text-red-500" : "text-emerald-600"
                            }`}>
                ...
                <>
                  <div className="flex flex-col items-center text-center">
                    <div className="relative">
                      <img
                        src={selectedUser.verificationDocuments?.selfie?.url || "data:image/png;base64,"}
                        alt={selectedUser.name}
                        className="w-28 h-28 rounded-full object-cover border-4 border-emerald-100"
                      />

                      <div className={`absolute bottom-1 right-1 w-8 h-8 rounded-full border-4 border-white ${selectedUser.isSuspended ? "bg-red-400" : "bg-emerald-500"
                        }`} />
                    </div>
                  ...
                  <div className="mt-8 bg-[#F6FAF8] rounded-2xl p-5">
                    <div className="flex items-center justify-between">
                      <h4 className="font-semibold text-[#111827]">Account Status</h4>
                      <span className={`font-bold text-sm ${selectedUser.isSuspended ? "text-red-500" : "text-emerald-600"
                        }`}>
                    ...
                    <p className="text-sm text-gray-500 mt-2">
                      Verification: {selectedUser.isVerified ? "Verified ✓" : "Pending"}
                    </p>
                  </div>
                  ...
                  <div className="space-y-4 mt-8">
                    ...
                    <button className="w-full h-14 rounded-2xl bg-red-50 text-red-500 font-semibold hover:bg-red-100 transition-all flex items-center justify-center gap-2">
                      <UserX size={18} />
                      {selectedUser.isSuspended ? "Unsuspend Account" : "Suspend User Account"}
                    </button>
                  </div>
                </>
              ) : (
                // placeholder when no user is clicked
