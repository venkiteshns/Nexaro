    ...
    >
      ...
      >
        ...
        <div className="p-5 md:p-8 flex flex-col items-center text-center">
          <div className="w-12 h-12 md:w-16 md:h-16 rounded-full bg-red-50 border-2 border-red-100 flex items-center justify-center mb-4 md:mb-5">
            <Trash2 size={22} className="text-red-500 md:w-7 md:h-7" />
          </div>
          <h2 className="text-base md:text-xl font-extrabold text-gray-900 mb-2">
            Delete Profile?
          </h2>
          <p className="text-xs md:text-sm text-gray-500 leading-relaxed mb-1 px-2">
            This action is{" "}
            <span className="font-semibold text-gray-700">permanent</span> and
            cannot be undone.
          </p>
          <p className="text-[10px] md:text-xs text-gray-400 mb-5 md:mb-7">
            All your tasks, reviews and data will be erased.
          </p>
          <button 
            onClick={() => deleteProfile(userId)} 
            disabled={isLoading}
            className="w-full py-2.5 md:py-3 rounded-2xl bg-red-500 text-white text-xs md:text-sm font-bold hover:bg-red-600 active:scale-[0.98] transition-all duration-150 shadow-sm mb-2 md:mb-3 disabled:opacity-70 disabled:cursor-not-allowed disabled:hover:bg-red-300 disabled:active:scale-100" >
