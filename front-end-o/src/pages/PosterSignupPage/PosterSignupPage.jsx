      ...
      <div className="float-card card-task">
        ...
        <div className="card-footer">
          ...
          <span className="status">
            <span className="dot"></span> 4 workers bidding
          </span>
        </div>
      </div>
...
const SignupForm = () => {
  ...
  const isSubmittingForm = ["registering", "completed"].includes(verificationStatus);
  ...
  async function sendDataToBackend(data) {
    ...
    try {
      ...
      if (!cleanData.locationLat || !cleanData.locationLng) {
        ...
        setTimeout(() => { setVerificationStatus("idle"); setShowOtpModal(false); }, 2500);
        return;
      }
  ...
  return (
    <div className="signup-form-container">
      <div className="form-header">
        <h2>
          Create Your <span className="text-accent">Poster</span> Account
        </h2>
      ...
      >
        ...
        <div className="form-group checkbox-group">
          <label className="checkbox-label">
            ...
            <span className="terms-text">
              ...
              <a href="#">Privacy Policy</a>. I understand NEXARO uses my
              location to show nearby tasks.
            </span>
          </label>
          {errors.terms && (
        ...
        >
          ...
          {isFormSending ? "Sending OTP..." : "Create My Account"}
        </button>
        ...
        <div className="ws-modal-overlay">
          <div className={`ws-modal-content votp-card${verificationStatus === 'invalid' ? ' votp-card--shake' : ''}${verificationStatus === 'completed' ? ' votp-card--success-flash' : ''}`}>
            ...
            <form onSubmit={handleVerifyOtp} className="votp-form">
              ...
              <button
                type="submit"
                className={`btn-primary votp-btn${
